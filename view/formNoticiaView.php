...
<h1 class="display-4">Publicar noticia</h1>

<form action="index.php?page=generarNoticia" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input class="form-control mb-1" type="file" name="imagen">
    </div>

    <label>Contenido:</label>
    <textarea id="mytextarea" name="descripcion">Escriba el contenido de la noticia con el formato que desee.</textarea>
